...
export default function ContentsCard({ facilities }: ContentsCardProps) {
  return (
      ...
      {facilities.length ? (
        facilities.map((facility) => (
          <Card
            ...
            onClick={() => console.log(`Clicked on ${facility.id}`)}
          >
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center mt-1">
                ...
                <Text className="text-sm text-gray-500 ml-2">
                  {facility.suburb.name}, {facility.lga.name} in {facility.state.name}
                </Text>
              </div>              
            </div>
          </Card>
